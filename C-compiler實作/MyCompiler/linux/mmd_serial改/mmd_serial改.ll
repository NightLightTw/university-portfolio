...
14:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double noundef %23)
  br label %25
...
define dso_local i32 @main() #0 {
  ...
  %6 = sext i32 %5 to i64
  %7 = mul i64 8, %6
  %8 = call noalias i8* @malloc(i64 noundef %7) #5
  ...
  store double** %19, double*** @c, align 8
  store i32 0, i32* %3, align 4
  br label %20
...
24:                                               ; preds = %20
  ...
  %36 = mul i64 8, %35
  %37 = call noalias i8* @malloc(i64 noundef %36) #5
  ...
  %45 = mul i64 8, %44
  %46 = call noalias i8* @malloc(i64 noundef %45) #5
...
65:                                               ; preds = %61
  ...
  store double 5.000000e+00, double* %81, align 8
...
97:                                               ; preds = %56
  ...
  %99 = call double @matrixMult(i32 noundef %98)
  ...
  %111 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double noundef %110)
