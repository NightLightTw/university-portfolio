...
.lr.ph22:                                         ; preds = %._crit_edge23, %.preheader.lr.ph
  %indvars.iv33 = phi i64 [ 0, %.preheader.lr.ph ], [ %indvars.iv.next34, %._crit_edge23 ]
  br label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %._crit_edge, %.lr.ph22
  %indvars.iv28 = phi i64 [ 0, %.lr.ph22 ], [ %indvars.iv.next29, %._crit_edge ]
...
._crit_edge23:                                    ; preds = %._crit_edge
  ...
  br i1 %exitcond37.not, label %._crit_edge26, label %.lr.ph22, !llvm.loop !9
...
._crit_edge:                                      ; preds = %3
  ...
  br i1 %exitcond19.not, label %._crit_edge13, label %.lr.ph, !llvm.loop !11
