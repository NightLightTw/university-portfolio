...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = tail call i64 @time(i64* noundef null) #4
...
14:                                               ; preds = %3
  ...
  %19 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 noundef %.01923, double noundef %18)
  br label %20
...
21:                                               ; preds = %20
  ...
  %25 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @.str.1, i64 0, i64 0), double noundef %24)
  ret i32 0
}
