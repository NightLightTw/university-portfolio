...
tailrecurse:                                      ; preds = %5, %3
  %.tr11 = phi i32 [ %1, %3 ], [ %8, %5 ]
  %4 = icmp slt i32 %.tr11, %2
  br i1 %4, label %5, label %9

5:                                                ; preds = %tailrecurse
  %6 = tail call i32 @partition(ptr noundef %0, i32 noundef %.tr11, i32 noundef %2)
  %7 = add nsw i32 %6, -1
  tail call void @quickSort(ptr noundef %0, i32 noundef %.tr11, i32 noundef %7)
  %8 = add nsw i32 %6, 1
  br label %tailrecurse
...
2:                                                ; preds = %0, %2
  ...
  %3 = getelementptr inbounds [10000 x i32], ptr %1, i64 0, i64 %indvars.iv
...
6:                                                ; preds = %2
  call void @quickSort(ptr noundef nonnull %1, i32 noundef 0, i32 noundef 9999)
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  call void @printArray(ptr noundef nonnull %1, i32 noundef 10000)
  ret i32 0
}
